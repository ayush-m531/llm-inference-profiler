"""
Quality calibration, second text pair.

Same method as 06_quality_calibration.py, different perplexity text and
generation prompt. Purpose: check whether the split-point ranking observed in
06 (L7 reaching the cheapest acceptable scheme, L11 requiring more) holds on
different input, or whether it was specific to that text.

Writes both a JSON file and a TXT transcript.
"""
import torch
import json
import os
...
RUN_TAG = "06_01_quality_calibration"
...
# Different domain from 06: narrative/historical rather than technical prose.
...
GEN_PROMPT = "The main causes of the Industrial Revolution were"
...
out(f"Text domain: narrative/historical (06 used technical prose)")
